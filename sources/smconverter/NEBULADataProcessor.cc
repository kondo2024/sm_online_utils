...
//  fhidtu = new TH2D("nebula_idtu","NEBULA ID TuRaw",184,0.5,184.5,100,-200,400);
//  fhidtd = new TH2D("nebula_idtd","NEBULA ID TdRaw",184,0.5,184.5,100,-200,400);
  fhidtu = new TH2D("nebula_idtu","NEBULA ID TuRaw",184,0.5,184.5,100,0,4000);
  fhidtd = new TH2D("nebula_idtd","NEBULA ID TdRaw",184,0.5,184.5,100,0,4000);
