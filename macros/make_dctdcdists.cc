...
void make_dctdcdists(Int_t nRun=12){
  ...
  TH1* hbdc1idtdc = new TH2D("hbdc1idtdc","BDC1 ID TDC",128,0.5,128.5,100,0,20000);
  
  TH1* hbdc2id = new TH1D("hbdc2id","BDC2 ID",128,0.5,128.5);
  hbdc2id->SetMinimum(0);
  TH1* hbdc2idtdc = new TH2D("hbdc2idtdc","BDC2 ID TDC",128,0.5,128.5,100,0,20000);
